            ...
            <div className="row justify-content-center">
              <div className="col-md-10">
                <div className="skill-icons mb-4 d-flex justify-content-center flex-wrap">
                  <i className="fab fa-python mx-2 skill-icon" data-aos="zoom-in" data-aos-delay="200"></i>
                  <i className="fab fa-react mx-2 skill-icon" data-aos="zoom-in" data-aos-delay="400"></i>
                  <i className="fab fa-js-square mx-2 skill-icon" data-aos="zoom-in" data-aos-delay="600"></i>
                  <i className="fas fa-database mx-2 skill-icon" data-aos="zoom-in" data-aos-delay="800"></i>
                  <i className="fas fa-chart-line mx-2 skill-icon" data-aos="zoom-in" data-aos-delay="1000"></i>
                  <i className="fas fa-cubes mx-2 skill-icon" data-aos="zoom-in" data-aos-delay="1200"></i>
                </div>
              </div>
            </div>
